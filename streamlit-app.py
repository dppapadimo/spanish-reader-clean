...
# - Auto translate
# - Auto save to Excel
# - View learned words (word + translation)
# - Wrap text display
# Date: 2026-04-13
# ----------------------------------------
...
if text:
    ...
    st.markdown(
        f"<div style='line-height:1.6'>{highlighted}</div>",
    ...
    if st.session_state.words_data:
        st.subheader("📚 View unknown words")
        ...
        st.markdown(
            f"<div style='line-height:1.6'>{words_view}</div>",
            unsafe_allow_html=True
        )
